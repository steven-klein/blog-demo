 ...
 * Should be included on any page the contact form exists.
 */
...
function processForm() {
  ...
  $formData = validateAndSanitzeFields($formData);
  ...
  if( empty($formData["errors"]) ) {
    ...
    $sent = ( mail("webmaster@test.dev", "Contact form message", $message) === true) ? true : false;
  }
 ...
 * @return array $formData
 */
function validateAndSanitzeFields($formData) {
